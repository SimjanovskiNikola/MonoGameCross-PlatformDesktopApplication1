...
public class EarthMagic : Magic{
    public EarthMagic(Texture2D texture2D, Rectangle rectangle, Vector2 pos, Vector2 des, int type) 
        : base(texture2D, rectangle, pos, des, type) {
        
        velocityMagic = 15;
        Damage = Mathematics.RandomNumber(0, 3);
    }
